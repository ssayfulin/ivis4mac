  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested person" do
        ...
        Person.any_instance.should_receive(:update).with({'second_name2' => 'params'})
        put :update, {:id => person.to_param, :person => {'second_name2' => 'params'}}, valid_session

        puts person.second_name
